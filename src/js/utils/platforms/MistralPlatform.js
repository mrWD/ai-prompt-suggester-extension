// Mistral platform handling
class MistralPlatform {
  ...
  static getTargetElement() {
    return document.querySelector('[data-testid="library-selection-button"]');
  }
  ...
  static getObserverConfig() {
    return {
      childList: true,
      subtree: true,
      selector: '[data-testid="library-selection-button"]'
    };
  }
}

// Make MistralPlatform available globally
window.MistralPlatform = MistralPlatform;